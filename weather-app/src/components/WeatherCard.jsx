    ...
    >
      ...
      <div className="flex flex-col w-[250px] h-[230px] ml-[48px] absolute z-10 top-[460px] justify-start">
        {isDark ? (
          <div>
            <p
              className={` text-[106px] manrope font-[800] text-transparent bg-gradient-to-t bg-clip-text from-[#F9FAFB] to-[rgba(249, 250, 251, 0.00) 100%)]`}
            >
              {temp}°
            </p>
          ...
          <div>
            <p
              className={` text-[106px] manrope font-[800] text-transparent bg-gradient-to-t bg-clip-text from-[#111827] 0% to-[#6B7280] 100%`}
            >
              {temp}°
            </p>
